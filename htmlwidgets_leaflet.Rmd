...
### Modificar la forma de los marcadores:
...
La librería leaflet, y el paquete de R para interactuar con la misma, tiene otras muchas opciones (colores, leyendas, imágenes...) para realizar mapas muy ricos. No dejes de consultar la <a href="http://rstudio.github.io/leaflet/" target="_blank">página de ayuda</a> para descubrirlas y practicar con las mismas.
