...
Como en el resto de paquetes htmlwidhwet, la función saveWidget permite grabar el objeto gráfico.

*Modifica el nombre "map.html" por otro que más te convenga y ejecuta el código para generar el fichero html*

```{r leaflet-savewidget, exercise=TRUE, exercise.eval=FALSE}
m <- leaflet()
m <- addTiles(m)
m <- addMarkers(m, lat=40.5453, lng=-3.69611, popup = "<a href='http://www.uam.es/UAM/Home.htm?language=es' target='_blank'>UAM</a>")
