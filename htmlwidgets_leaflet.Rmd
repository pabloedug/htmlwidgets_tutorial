...
- La función addMarkers(): añade puntos en el mapa (los especificados al llamar la función, o bien los contenidos en el parámetro data del objeto leaflet inicial). Su aspecto por defecto son "dropped pins".
...
quiz(
  question("Si en vez del argumento popup utilizas el argumento label, ¿qué ocurrre?",
    answer("No aparece nada"),
    answer("Aparecen las etiquetas al pasar el cursor por encima", correct = TRUE),
    answer("Desaparecen los iconos y son sustituidos por etiquetas")
  )
)
```
